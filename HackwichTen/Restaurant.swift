...
B. Adopt the MKAnnotation protocol
*/
import MapKit

// PART4-#4.A)Import MapKit Framework
class Restaurant: NSObject, MKAnnotation {
  /*
    5. Let’s set up the Restaurant class.
    A.  Declare three variables that will hold data that the annotation will access (see lines 13, 14 & 15)
    B.  Initialize the MKAnnotation object
   */
